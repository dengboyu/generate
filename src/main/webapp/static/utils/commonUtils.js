...
var UrlUtils={
     ...
     */
    urlAddParamter:function(key,value,url){
        if(url){
            urlAppend = url;
        }
        if(!urlAppend){
...
var NumUtils={
    ...
    * @return {[type]}     [description]
    */
    oneToTwoOrThree:function(num,bit){
        if(bit==2){
            if(num<10){
                num='0'+num;
            }
...
var DateUtils={
    ...
    * @param {Object} second
    */
    secondToFriendly:function(second){
...
var ArrayUtils={
     ...
     * @return {[type]}   [description]
     */
    removeValue: function(arr,indexs) {
     ...
     * @return {[type]}   [description]
     */
    removeRepeatValue: function(arr,indexs) {
        var index=0;
        while(index!=-1){
...
var StringUtils={
     ...
     */
    changeUpperByStr:function(str,pattrn){
...
var FileUtils={
     ...
     * @return {[type]}      [description]
     */
    transformFileSize:function(size){
     ...
     * @return {[type]}          [description]
     */
    checkIsImage: function(fileName){
